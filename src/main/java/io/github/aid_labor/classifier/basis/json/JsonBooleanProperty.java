...
@JsonDeserialize (
		converter=JsonBooleanProperty.BooleanZuPropertyKonverter.class
)
public class JsonBooleanProperty extends SimpleBooleanProperty {
	
	public static class PropertyZuBooleanKonverter extends StdConverter<BooleanProperty, Boolean> {
		@Override
	...
	public static class BooleanZuPropertyKonverter extends StdConverter<Boolean, BooleanProperty> {
		@Override
