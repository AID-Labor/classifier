...
public class JsonIntegerProperty extends SimpleIntegerProperty {
	...
	public static class PropertyZuIntegerKonverter
			extends StdConverter<IntegerProperty, Integer> {
		@Override
	...
	public static class IntegerZuPropertyKonverter
			extends StdConverter<Integer, IntegerProperty> {
		@Override
