...
public class Validierung implements Schliessbar {
...
// private	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##
    ...
    public static final class ValidierungBuilder {
        ...
        public Validierung build() {
            return new Validierung(validierung, errorMessages);
        }
    }
...
// private	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##
	...
	private Validierung(BooleanBinding valid, ObservableList<ObservableValue<String>> errorMessages) {
