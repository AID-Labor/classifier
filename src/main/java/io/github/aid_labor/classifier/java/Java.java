...
// public	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##
    ...
    public static Set<Datentyp> PRIMITIVE_DATENTYPEN() {
        return Collections
                .unmodifiableSet(Set.of(BOOLEAN_PRIMITIV(), BYTE_PRIMITIV(), SHORT_PRIMITIV(), INT_PRIMITIV(),
                        LONG_PRIMITIV(), FLOAT_PRIMITIV(), DOUBLE_PRIMITIV(), CHAR_PRIMITIV(), VOID_PRIMITIV()));
    }

    private static final Set<String> primitiveDatentypen = Collections
            .unmodifiableSet(Set.of("boolean", "byte", "short", "char", "int", "long", "float", "double"));
...
// public	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##	##
    ...
    public List<String> getPrimitiveDatentypen() {
        return Collections.unmodifiableList(new ArrayList<>(primitiveDatentypen));
    }
    
    public boolean istPrimitiv(String typ) {
        return primitiveDatentypen.contains(typ);
    }
